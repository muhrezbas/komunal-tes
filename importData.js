    ...
    if (err) throw err
        ...
        data.pipe(csv())
            ...
            .on('end', () => {
                ...
                let createTable = `CREATE TABLE IF NOT EXISTS borrowers (Id varchar(200) NOT NULL, CustomerName varchar(200)  NULL, DatePurchase varchar(200)  NULL, Amount_due__c decimal(15,2) NOT NULL, Discount__c int(11) NOT NULL, GST__c int(11) NOT NULL, CreatedDate timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP, LastModifiedDate timestamp NULL DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP, deleted_at timestamp NULL DEFAULT NULL, PRIMARY KEY (id))`
